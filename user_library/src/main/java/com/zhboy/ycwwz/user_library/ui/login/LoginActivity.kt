...
import com.zhboy.ycwwz.base_library.event.login.LoginEvent
...
import com.zhboy.ycwwz.base_library.utils.MyLinkedMovementMethod
...
import com.zhboy.ycwwz.web_library.ui.CommonWebActivity
...
class LoginActivity : BaseActivity(), LoginContract.View, OnLazyClickListener {
    ...
    override fun init() {
        ...
        val text = "登录抽奖即表明同意《基础框架用户服务协议》和《基础框架用户隐私政策》"
