package com.zhboy.ycwwz.base_library.widgets.recycleview.divider;
...
public class RecyclerSpace extends RecyclerView.ItemDecoration {
    ...
    public RecyclerSpace(int space, int color) {
        this.space = space;        this.color = color;
    ...
    public void getItemOffsets(Rect outRect, View view, RecyclerView parent, RecyclerView.State state) {
        if (parent.getLayoutManager() != null) {
            if (parent.getLayoutManager() instanceof LinearLayoutManager && !(parent.getLayoutManager() instanceof GridLayoutManager)) {                if (((LinearLayoutManager) parent.getLayoutManager()).getOrientation() == LinearLayoutManager.HORIZONTAL) {
