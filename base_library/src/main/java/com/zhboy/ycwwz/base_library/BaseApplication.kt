package com.zhboy.ycwwz.base_library
...
import com.zhboy.ycwwz.base_library.base.CrashHandler
import com.zhboy.ycwwz.base_library.utils.CommonUtils
import com.zhboy.ycwwz.base_library.utils.MiitHelper
...
open class BaseApplication : MultiDexApplication() {
    ...
    override fun onCreate() {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.P) {
            ...
            if ("com.zhboy.ycwwz" != processName) {//判断不等于默认进程名称
