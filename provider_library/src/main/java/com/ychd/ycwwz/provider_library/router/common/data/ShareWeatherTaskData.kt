package com.ychd.ycwwz.provider_library.router.common.data

import android.graphics.Color
import androidx.annotation.ColorInt
import androidx.annotation.DrawableRes
import com.ychd.ycwwz.provider_library.R

// 任务分享天气 data
/**
 * @param date 日期 04月27日
 * @param temperature 天气
 * @param skyconIconResId 天气状况 icon id
 * @param skycon 天气状况
