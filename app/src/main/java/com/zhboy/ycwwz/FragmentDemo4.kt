...
class FragmentDemo4 : BaseLazyFragment() {
    override fun layoutResId(): Int = R.layout.fragment_layout

    override fun onFirstVisible() {
        super.onFirstVisible()
        toLogin.text = "FragmentDemo4"
...
//            .withInt(IntentData.UserCenterIntentData.intentLogin, 0)
        ...
        TLog.i("FragmentDemo4:onFirstVisible")
    }

    override fun onVisible() {
        super.onVisible()
        TLog.i("FragmentDemo4:onVisible")
    }

    override fun onInvisible() {
        super.onInvisible()
        TLog.i("FragmentDemo4:onInvisible")
    }

    companion object {
        fun newInstance() = FragmentDemo4()
    }
